...
HD_PWD='D:/VIVADO_Project/ECE520/ECE_520_Final_Project/hardware/Pmod_Kypd/Pmod_Kypd.runs/kypd_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kypd_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kypd_rst_ps7_0_50M_0.tcl

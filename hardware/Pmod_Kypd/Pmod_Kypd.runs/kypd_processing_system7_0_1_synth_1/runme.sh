...
HD_PWD='D:/VIVADO_Project/ECE520/ECE_520_Final_Project/hardware/Pmod_Kypd/Pmod_Kypd.runs/kypd_processing_system7_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kypd_processing_system7_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kypd_processing_system7_0_1.tcl

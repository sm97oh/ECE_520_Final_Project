...
HD_PWD='D:/VIVADO_Project/ECE520/ECE_520_Final_Project/hardware/Pmod_Kypd/Pmod_Kypd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kypd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kypd_wrapper.tcl

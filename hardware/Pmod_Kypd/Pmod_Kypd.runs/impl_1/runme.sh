...
HD_PWD='D:/VIVADO_Project/ECE520/ECE_520_Final_Project/hardware/Pmod_Kypd/Pmod_Kypd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log kypd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source kypd_wrapper.tcl -notrace
